...
- `maxPromptTokenCount`: The number of prompt tokens allowed per time unit
- `maxCompletionTokenCount`: The number of completion tokens allowed per time unit
- `maxTotalTokenCount`: The number of total tokens allowed per time unit
- `timeUnit`: The time unit for the rate limiting
